    ...
    appendNotificationBox({
        ...
        buttons: [
            { label: "Stop bothering me", 
                accessKey: "d", popup: null, 
                callback: function (bar, button) { 
                    disableFeedDetection(); 
                }
            },
            { label: "Never check this site", 
